...
import io.github.inference4j.model.LocalModelSource;
...
public class ImageClassificationExample {
    ...
    public static void main(String[] args) throws Exception {
    	System.setProperty("java.lang.System", "E:\\inference4j\\inference4j\\resnet50-v1-7");
//    	DistilBertTextClassifier
//        .builder()
//        .modelSource(new LocalModelSource(Path.of("E:\\inference4j\\resnet50-v1-7\\model.onnx", args)))
//        .build();
